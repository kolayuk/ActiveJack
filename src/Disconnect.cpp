 ...
 * @return initialized instance of CDisconnect
 */
CDisconnect* CDisconnect::NewL( 
		const TRect& aRect, 
		const CCoeControl* aParent, 
		MEikCommandObserver* aCommandObserver )
	{
	CDisconnect* self = CDisconnect::NewLC( 
			aRect, 
			aParent, 
			aCommandObserver );
 ...
 * @param aParent owning parent, or NULL
 * @param aCommandObserver command observer
 * @return new instance of CDisconnect
 */
CDisconnect* CDisconnect::NewLC( 
		const TRect& aRect, 
		const CCoeControl* aParent, 
		MEikCommandObserver* aCommandObserver )
	{
	CDisconnect* self = new ( ELeave ) CDisconnect();
...
void CDisconnect::ConstructL( 
	...
	TBuf<255> txt;
	CEikonEnv::Static()->ReadResource(txt,R_EMPTY_LISTBOX_DISCONNECT);
...
* @return count
*/
TInt CDisconnect::CountComponentControls() const
	{
...
*/
CCoeControl* CDisconnect::ComponentControl( TInt aIndex ) const
	{
	// [[[ begin generated region: do not modify [Generated Contents]
	switch ( aIndex )
		{
 ...
 */
void CDisconnect::LayoutControls()
	{
 ...
 *	Handle key events.
 */				
TKeyResponse CDisconnect::OfferKeyEventL( 
	...
	if (aKeyEvent.iCode==EKeyBackspace)
		...
		if (ListBox()->Model()->NumberOfItems()>0)
			{CMenuActions::DelAction(((CAknView*)iCommandObserver)->Id(),ListBox()->CurrentItemIndex());}
		}
	
	if ((aKeyEvent.iCode==EKeyEnter||aKeyEvent.iCode==EKeyOK)&&iListBox->Model()->NumberOfItems()==0) // select&&empty
		{((CAknView*)iCommandObserver)->MenuBar()->TryDisplayMenuBarL();}
 ...
 */				
void CDisconnect::InitializeControlsL()
	{
	iListBox = new ( ELeave ) CAknDoubleStyleListBox;
	iListBox->SetContainerWindowL( *this );
		{
		TResourceReader reader;
		iEikonEnv->CreateResourceReaderLC( reader, R_DISCONNECT_LIST_BOX );
	...
	AddListBoxEventHandlerL( 
			...
			&CDisconnect::HandleListBoxEnterKeyPressedL );
	AddListBoxEventHandlerL( 
			iListBox, 
			EEventItemSingleClicked, 
			&CDisconnect::HandleListBoxItemClickedL );
 ...
 */
void CDisconnect::HandleResourceChange( TInt aType )
	{
	CCoeControl::HandleResourceChange( aType );
	SetRect( iAvkonViewAppUi->View( TUid::Uid( EDisconnectViewId ) )->ClientRect() );
	// [[[ begin generated region: do not modify [Generated Contents]
	// ]]] end generated region [Generated Contents]
 ...
 */				
void CDisconnect::Draw( const TRect& aRect ) const
	{
	// [[[ begin generated region: do not modify [Generated Contents]
 ...
 */
void CDisconnect::AddListBoxItemL( 
 ...
 */
RArray< TInt >* CDisconnect::GetSelectedListBoxItemsLC( CEikTextListBox* aListBox )
	{
 ...
 */
void CDisconnect::DeleteSelectedListBoxItemsL( CEikTextListBox* aListBox )
	{
	CAknFilteredTextListBoxModel* model = 
		static_cast< CAknFilteredTextListBoxModel *> ( aListBox->Model() );
	if ( model->NumberOfItems() == 0 )
 ...
 *	Get the listbox.
 */
CAknDoubleStyleListBox* CDisconnect::ListBox()
	{
	return iListBox;
	}
 ...
 */
void CDisconnect::CreateListBoxItemL( TDes& aBuffer, 
 ...
 *	
 */
void CDisconnect::AddListBoxResourceArrayItemL( TInt aResourceId )
	{
 ...
 */
void CDisconnect::SetupListBoxIconsL()
	{
 ...
 */
TBool CDisconnect::HandleMarkableListCommandL( TInt aCommand )
	{
	return EFalse;
	}
 ...
 */
void CDisconnect::HandleListBoxEventL( 
 ...
 */
void CDisconnect::AddListBoxEventHandlerL( 
		CEikListBox* aListBox,
 ...
 */
void CDisconnect::HandleListBoxItemClickedL( 
		CEikListBox* aListBox,
		TListBoxEvent anEventType )
	{
	if (ListBox()->Model()->NumberOfItems()>0)
			{CMenuActions::EditAction(((CAknView*)iCommandObserver)->Id(),ListBox()->CurrentItemIndex());}		
	}

/**
 *	Handle the enterKeyPressed event
 */
void CDisconnect::HandleListBoxEnterKeyPressedL( 
		CEikListBox* aListBox,
		TListBoxEvent anEventType )
	{
	if (ListBox()->Model()->NumberOfItems()>0)
