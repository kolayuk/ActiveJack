...
void CAiPlayerPluginEngine::ConstructL()
    ...
    iPlaybackUtility->PropertyL( *this, EPbPropertyBalance );
...
void CAiPlayerPluginEngine::HandleMediaL( const CMPXMedia& aMedia, 
    ...
    if ( KErrNone == aError )
        ...
        if (aMedia.IsSupported(KMPXMediaGeneralUri))
            ...
            TParse filePath;
            iFs.Parse(aMedia.ValueText(KMPXMediaGeneralUri) ,filePath);
...
TInt CAiPlayerPluginEngine::Balance()
    {
    return iBalance;
    }
