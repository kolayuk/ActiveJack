 ...
 * @return initialized instance of CConnect
 */
CConnect* CConnect::NewL( 
		const TRect& aRect, 
		const CCoeControl* aParent, 
		MEikCommandObserver* aCommandObserver )
	{
	CConnect* self = CConnect::NewLC( 
			aRect, 
			aParent, 
			aCommandObserver );
 ...
 * @param aParent owning parent, or NULL
 * @param aCommandObserver command observer
 * @return new instance of CConnect
 */
CConnect* CConnect::NewLC( 
		const TRect& aRect, 
		const CCoeControl* aParent, 
		MEikCommandObserver* aCommandObserver )
	{
	CConnect* self = new ( ELeave ) CConnect();
...
void CConnect::ConstructL( 
	...
	TBuf<255> txt;
	CEikonEnv::Static()->ReadResource(txt,R_EMPTY_LISTBOX_CONNECT);
...
* @return count
*/
TInt CConnect::CountComponentControls() const
	{
...
*/
CCoeControl* CConnect::ComponentControl( TInt aIndex ) const
	{
	// [[[ begin generated region: do not modify [Generated Contents]
	switch ( aIndex )
		{
 ...
 *	Handle key events.
 */				
TKeyResponse CConnect::OfferKeyEventL( 
	...
	// ]]] end generated region [Generated Contents]
	if (aKeyEvent.iCode==EKeyBackspace) // C-button
		{
 ...
 */				
void CConnect::InitializeControlsL()
	{
	iListBox = new ( ELeave ) CAknDoubleStyleListBox;
	iListBox->SetContainerWindowL( *this );
		{
		TResourceReader reader;
		iEikonEnv->CreateResourceReaderLC( reader, R_CONNECT_LIST_BOX );
	...
	AddListBoxEventHandlerL( 
			...
			&CConnect::HandleListBoxEnterKeyPressedL );
	AddListBoxEventHandlerL( 
			iListBox, 
 ...
 */
void CConnect::HandleResourceChange( TInt aType )
	{
	CCoeControl::HandleResourceChange( aType );
	SetRect( iAvkonViewAppUi->View( TUid::Uid( EConnectViewId ) )->ClientRect() );
	// [[[ begin generated region: do not modify [Generated Contents]
	// ]]] end generated region [Generated Contents]
 ...
 */				
void CConnect::Draw( const TRect& aRect ) const
	{
	// [[[ begin generated region: do not modify [Generated Contents]
 ...
 */
RArray< TInt >* CConnect::GetSelectedListBoxItemsLC( CEikTextListBox* aListBox )
	{
 ...
 */
void CConnect::DeleteSelectedListBoxItemsL( CEikTextListBox* aListBox )
	{
	CAknFilteredTextListBoxModel* model = 
		static_cast< CAknFilteredTextListBoxModel *> ( aListBox->Model() );
	if ( model->NumberOfItems() == 0 )
 ...
 *	Get the listbox.
 */
CAknDoubleStyleListBox* CConnect::ListBox()
	{
	return iListBox;
	}
 ...
 */
void CConnect::CreateListBoxItemL( TDes& aBuffer, 
 ...
 *	
 */
void CConnect::AddListBoxResourceArrayItemL( TInt aResourceId )
	{
 ...
 */
void CConnect::SetupListBoxIconsL()
	{
 ...
 */
TBool CConnect::HandleMarkableListCommandL( TInt aCommand )
	{
	return EFalse;
	}
 ...
 */
void CConnect::HandleListBoxEventL( 
 ...
 */
void CConnect::AddListBoxEventHandlerL( 
		CEikListBox* aListBox,
 ...
 */
void CConnect::HandleListBoxEnterKeyPressedL( 
		CEikListBox* aListBox,
		TListBoxEvent anEventType )
	{
