...
void CSettingList::HandleResourceChange( TInt aType )
	...
	SetRect( iAvkonViewAppUi->View( KSettingsViewId )->ClientRect() );
	// [[[ begin generated region: do not modify [Generated Contents]
	// ]]] end generated region [Generated Contents]
 ...
 *	Get the listbox.
 */
CAknDoubleStyleListBox* CSettingList::ListBox()
	{
	return iListBox;
	}
...
void CSettingList::HandleListBoxEventL( 
	...
	{
	if (anEventType==EEventEnterKeyPressed){HandleListBoxEnterKeyPressedL(iListBox,anEventType);}
	if (anEventType==EEventItemClicked){HandleListBoxItemClickedL(iListBox,anEventType);}
	}
