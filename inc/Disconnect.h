...
/**
 * Container class for Disconnect
 * 
 * @class	CDisconnect Disconnect.h
 */
class CDisconnect : public CCoeControl
	,MEikListBoxObserver	{
public:
	// constructors and destructor
	CDisconnect();
	static CDisconnect* NewL( 
		const TRect& aRect, 
		const CCoeControl* aParent, 
		MEikCommandObserver* aCommandObserver );
	static CDisconnect* NewLC( 
		const TRect& aRect, 
		const CCoeControl* aParent, 
		MEikCommandObserver* aCommandObserver );
	void ConstructL( 
...
private: 
	typedef void ( CDisconnect::*ListBoxEventHandler )( 
			CEikListBox* aListBox, 
